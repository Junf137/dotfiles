---
name: modal-run
description: Modal run management — launching, monitoring, debugging, and stopping training jobs. Use when running Modal apps, handling timeouts, building container images, debugging live containers, or managing parallel experiments.
---
