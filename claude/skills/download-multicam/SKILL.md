...
description: Download 6-camera multicam episode videos and calibration files. Use when the user wants to download episode data by ID, fetch multicam recordings, or get calibration files for episodes.
---
